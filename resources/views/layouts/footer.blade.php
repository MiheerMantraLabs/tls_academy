      ...
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-12 col-12">
          <div class="footer-link">
            <h5>About Us</h5>
            <p>If you are interested in learning how to build a website, I encourage you to check out TLS Academy's website development courses. They offer a great way to learn the skills you need to succeed in this exciting field.</p>
