        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-mg-6 col-12">
                <div class="banner-box">
                    ...
                    <button type="button" id="button-design2" class="tls-button">Explore More</button>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-mg-6 col-12">
...
<!-- <section id="banner-feature">
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6 border">
